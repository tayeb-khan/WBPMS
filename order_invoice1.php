...
<?php 
                ...
                include"db.php";
					...
					$id = $_GET["Print_id"];
							...
							$product_query = "SELECT appointment.id,appointment.name,appointment.service,appointment.date,appointment.time,appointment.mobile,appointment.email,services.service_name,services.price from appointment INNER JOIN services on appointment.service=services.service_name ORDER BY appointment.id DESC ";
						...
						<div class="row invoice-table">
							<div class="col-md-12">
								<table border="0" class="itemLists">
									<thead>
										<tr><th>Sl No</th><th>Date</th><th>time</th><th>Service name</th><th>prize</th></tr>
									</thead>
									<tbody>
