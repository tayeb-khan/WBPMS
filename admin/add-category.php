...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  category(category_name) value('$catname')");
    if ($query) {
						...
						<div class="form-body">
							<form method="post">
							 ...
							 <div class="form-group"> 
							 	...
							 	<input type="text" class="form-control" id="catname" name="catname" placeholder="Categoty Name" value="" required="true"> 
							 </div> 
