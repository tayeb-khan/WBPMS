...
if ($_SESSION['type'] == 0) {
  ...
  {
    $adminid=$_SESSION['cusid'];
    $aname=$_POST['adminname'];
  $mobno=$_POST['contactnumber'];
  
     $query=mysqli_query($con, "update users set username ='$aname', phone='$mobno' where id='$adminid'");
    if ($query) {
...
?>
							 ...
							 <div class="form-group"> 
							 	...
							 	<input type="text" id="contactnumber" name="contactnumber" class="form-control" value="<?php  echo $row['phone'];?>"> 
							 </div>
							 <!-- <div class="form-group"> 
