...
<?php 
                ...
                include"db.php";
					...
					$id = $_GET["Print_id"];
							...
							$product_query = "SELECT appointment.id,appointment.first_name,appointment.last_name,appointment.service,appointment.date,appointment.mobile,appointment.email,services.service_name,services.prize from appointment INNER JOIN services on appointment.service=services.service_name where appointment.id= $id ";
