...
<html>
<head>
<title>PMS || Completed Appointment</title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Completed Appointment</h3>
  ...
  <thead>
    ...
    <tbody>
							...
							<?php 
							$product_query = "SELECT * FROM appointment   where status=3";
		...
		$sl = 0;
										while($row = mysqli_fetch_array($run_query)){
										  ...
										  <tr>
											...
											<a  class="btn btn-success" href="order_invoice.php?Print_id=<?php echo $id;?>">Print !</a>
