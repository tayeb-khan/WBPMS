...
<html>
<head>
<title>PMS || New Appointment</title>
...
<body class="cbp-spmenu-push">
  ...
  <thead>
    ...
    <tbody>
							...
							<?php 
							$product_query = "SELECT * FROM appointment   where status='0' ";
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenu1">
    <a class="dropdown-item btn btn-defalut" href="edit_orders.php?Aid=<?php echo $id;?>">Accept</a><br>
    <a class="dropdown-item btn btn-defalut" href="edit_orders.php?Rid=<?php echo $id;?>">Reject</a><br>
    <a class="dropdown-item btn btn-defalut" href="edit_orders.php?Cid=<?php echo $id;?>">Completed</a><br>
