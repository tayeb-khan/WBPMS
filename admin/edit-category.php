...
if(isset($_POST['submit']))
 ...
 $eid=$_GET['editid'];
    ...
    $query=mysqli_query($con, "update  category set category_name='$catname' where category_id='$eid' ");
    if ($query) {
...
?> 
							 ...
							 <div class="form-group"> 
							 	...
							 	<input type="text" class="form-control" id="catname" name="catname" placeholder="Category Name" value="<?php  echo $row['category_name'];?>" required="true"> 
							 </div> 
							 <?php } ?>
